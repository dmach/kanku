Vue.component('help-job-history',{
  template: `
<b-modal ref="modalHelpJobHistory" hide-footer title="Help">'
<h1>Job History Help</h1>

<p>
In the job history page you can see a list of all jobs in kanku. They can be filtered by their current state or various other filters can be applied with the search field. See the <img src="`+uri_base+`/images/help/questionmark.png" alt="questionmark"> on the job history page for detailed information how to use the search field.
</p>
